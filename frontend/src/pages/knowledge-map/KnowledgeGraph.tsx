  ...
  return (
    <div className="relative w-full h-[600px] bg-slate-50/50 rounded-[3rem] border border-border/50 overflow-hidden cursor-move shadow-inner">
      ...
      <div className="absolute bottom-8 left-8 flex flex-col gap-2">
        <Button variant="secondary" size="icon" className="rounded-xl shadow-lg" onClick={() => setTransform(p => ({ ...p, k: p.k * 1.2 }))} aria-label="Zoom in"><MagnifyingGlassPlus className="h-4 w-4" /></Button>
        <Button variant="secondary" size="icon" className="rounded-xl shadow-lg" onClick={() => setTransform(p => ({ ...p, k: p.k * 0.8 }))} aria-label="Zoom out"><MagnifyingGlassMinus className="h-4 w-4" /></Button>
        <Button variant="secondary" size="icon" className="rounded-xl shadow-lg" onClick={() => setTransform({ x: 0, y: 0, k: 1 })} aria-label="Reset zoom"><ArrowsOut className="h-4 w-4" /></Button>
      </div>
