...
SUBJECT_CONTEXTS = {
    ...
    '高中化学': '高中化学（人教版）核心知识体系，共5册：必修一（物质及其变化、金属与非金属元素化合物）、必修二（化工非金属元素、化学反应与能量、化学反应速率与限度、有机化合物基础）、选择性必修一（化学反应热效应、化学反应速率与化学平衡、水溶液中的离子平衡、化学反应方向与调控）、选择性必修二（原子结构与性质、分子结构与性质、晶体结构与性质）、选择性必修三（有机化合物的结构、烃、烃的衍生物、生物大分子、合成高分子、有机合成路线设计）。基于《普通高中化学课程标准（2017年版2020年修订）》和高考化学全国卷考试大纲。',
    '高中生物': '高中生物（人教版）核心知识体系，共5册：必修一（走进细胞、组成细胞的分子、细胞的基本结构、细胞的物质运输、细胞的能量代谢、细胞的生命历程）、必修二（遗传因子的发现、基因与染色体的关系、基因的本质、基因的表达、基因突变与变异、现代生物进化理论）、选择性必修一（内环境与稳态、神经调节、体液调节、免疫调节、植物生命活动调节）、选择性必修二（种群动态、群落演替、生态系统及其稳定性、人与环境）、选择性必修三（发酵工程、细胞工程、基因工程、生物技术安全与伦理）。基于《普通高中生物课程标准（2017年版2020年修订）》和高考生物全国卷考试大纲。',
