...
XIAOYU_PROMPT = """你是小宇（XiaoYu），UniMind.ai 的 AI 学习规划师。
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        bot, created = Bot.objects.update_or_create(
            ...
            defaults={
                'bot_type': 'planner',
                'system_prompt': XIAOYU_PROMPT,
                'is_exclusive': True,
                'is_active': True,
                'institution': None,
            },
        )
        from ai_assistant.prompt_sync import write_bot_prompt_file
        write_bot_prompt_file(bot, XIAOYU_PROMPT)
