...
从教师出题、学生刷题、评分批改到知识追踪，全链路 Agent 化。基于 Django 6.0 + React 19 构建。底层是四层算法架构：Memorix 自进化记忆调度（图扩散 + 再巩固窗口）、IRT 机构级认知诊断、变式题匹配、MUTAR 自进化管线。12 学科 11,908 知识点知识图谱。B2B 机构基础设施。
